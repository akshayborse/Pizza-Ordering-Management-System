...
if(isset($_POST['submit']))
{
	...
	{	
		...
		if($_POST['c1']==$_POST['c2'])
		{
			...
			else
			{
						...
						$query = "INSERT INTO users VALUES ('','$name','$n','$pass','$em','$gen','$mob','$add')";
	...
	{
		echo '<script>alert("Confirm password not match, try again!")</script>';
	}
...
<form method="post" enctype="multipart/form-data">
	...
	<p><b>Conf Password : </b><input type="password" name="upass1" required/>*</p>
    <p><b>Email : </b><input type="email" name="umail" required/>*</p>
    <p><b>Gender : </b><input type="radio" name="gender" value="Male">Male&nbsp;<input type="radio" name="gender" value="Female">Female</p>
